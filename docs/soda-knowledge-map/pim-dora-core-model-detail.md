...
モデルの特徴は「慎重な進化」にあります。毎年の研究レポートで発見された新たな知見をそのまま取り込むのではなく、複数年にわたって再現性が確認され、実務者によって実際に活用された知見だけを Core Model に反映します。
...
![DORA Core Model v2.1.0 の予測経路図](https://dora.dev/research/core/assets/dora-core-v2.1.0-detail.png)

*出典: [DORA Research（detailビュー）](https://dora.dev/research/?view=detail) — DORA Research Program*
